...
# save to file
  ggsave(filename = "byCreek_GAM_figure_2023.pdf", plot = byCreek_figure, device = "pdf", path = "./COBP_GAMFigures/COBP_GAMFigures_2023")
